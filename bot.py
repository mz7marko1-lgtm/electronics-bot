...
def callback_listener(call):
    ...
    if call.data == "cat1": 
        bot.edit_message_text("📘 الأساسيات:", call.message.chat.id, call.message.message_id, reply_markup=menu_cat1())
    elif call.data == "cat2": 
        bot.edit_message_text("🚀 المحاكاة:", call.message.chat.id, call.message.message_id, reply_markup=menu_cat2())
    elif call.data == "cat3": 
        bot.edit_message_text("🖥️ التصميم:", call.message.chat.id, call.message.message_id, reply_markup=menu_cat3())
    elif call.data == "cat4": 
        bot.edit_message_text("🔍 المراجع:", call.message.chat.id, call.message.message_id, reply_markup=menu_cat4())
    elif call.data == "back_to_main": 
        bot.edit_message_text("مرحباً بك! اختر فئة:", call.message.chat.id, call.message.message_id, reply_markup=main_menu())
